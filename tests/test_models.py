...
class TestProductModel(unittest.TestCase):
    ...
    def test_deserialize_with_invalid_available_type(self):
        """It should not deserialize a Product with a non-boolean available field"""
        data = {
            "name": "Hammer",
    ...
    def test_find_by_price_with_string(self):
        """It should find a Product by price when price is passed as a string"""
        ...
        self.assertEqual(Decimal(products[0].price), Decimal("19.99"))
    ...
    def test_update_a_product_invalid_id(self):
        """It should Raise a DataValidationErrorDataValidationError """
        product = ProductFactory()
        product.id = None
        product.create()
        print(product)
    ...
    def test_find_by_category(self):
        ...
        product1 = ProductFactory(category=Category.TOOLS)
        product2 = ProductFactory(category=Category.FOOD)
